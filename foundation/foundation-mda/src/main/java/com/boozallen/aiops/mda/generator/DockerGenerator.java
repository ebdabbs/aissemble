...
public class DockerGenerator extends AbstractResourcesGenerator {
     ...
     * | policyDecisionPointAiopsSecurityProperties  | general-docker/policy-decision-point.aissemble-security.properties.vm  | krausening/base/aiops-security.properties  |
